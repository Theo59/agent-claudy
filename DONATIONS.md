...
*Réseau Bitcoin — accepte BTC*

```
bc1qju0dqj8g7yzx4hedw65yszc8dqxmu4xnmxpgzj
```

![QR Bitcoin](media/qr/btc.svg)

## Ethereum / EVM

*Ethereum & réseaux EVM — accepte ETH · USDC (ERC-20) · USDT (ERC-20)*

```
0xfaB207eC4E16533401EA14cA1ac5Ed33664dC4A5
```

![QR Ethereum / EVM](media/qr/evm.svg)

## Solana

*Réseau Solana — accepte SOL · USDC (SPL) · USDT (SPL)*

```
H1Viz1tBoAFjZ1yE6M4cZx8vbiEV2h2mUf3ZTixg2x6p
```

![QR Solana](media/qr/sol.svg)
